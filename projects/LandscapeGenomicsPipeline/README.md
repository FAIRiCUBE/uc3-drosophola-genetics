...
This repository is supposed to hold documentation on the Workflow conducted in the scope of the UC3 Project of [FAIRiCUBE](https://fairicube.nilu.no/).
...
The file structure can be taken from [Env.csv](data/environmental/fairicube/Env_imputed.csv) which is an outcome of our workflow and also part of this repository and looks the following. 
...
#### Suggested Download Tool FAIRiCUBE QueryCube And More
...
- [QueryCube in the FAIRiCUBE STAC catalogue](https://catalog.eoxhub.fairicube.eu/collections/no-ML%20collection/items/H6OSUK7TD8)
...
- [Code to Access S3 data](projects/LandscapeGenomicsPipeline/scripts/access_sr_bucket.py)
...
>>  -  Imutation of missing data (In the course of the project, a method for imputing population genomic data at allele frequency level was developed: [see here](https://github.com/FAIRiCUBE/uc3-drosophola-genetics/tree/main/projects/gap_filling). or in the FAIRiCUBE [STAC Catalogue](https://catalog.eoxhub.fairicube.eu/collections/ML%20collection/items/LFT4VLQJOC )) 
>
