...
python ${WD}/makeWindows/scripts/splitChromatin.py \
    --input /media/inter/ssteindl/FC/usecaserepo/uc3-drosophola-genetics/projects/LandscapeGenomicsPipeline/data/Subsample3.vcf.gz \
...
python ${WD}/makeWindows/scripts/vcf2af.py \
    --input /media/inter/ssteindl/FC/usecaserepo/uc3-drosophola-genetics/projects/LandscapeGenomicsPipeline/data/Subsample3.vcf.gz \
    --output ${WD}/makeWindows/data/Europe_50kMutations_genomewide
