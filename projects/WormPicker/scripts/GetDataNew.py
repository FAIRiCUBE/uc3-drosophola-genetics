...
with open("/media/ssteindl/fairicube/uc3/uc3-drosophola-genetics/projects/WormPicker/output/coveredsamples_wcs.csv", newline='') as csvfile:
    ...
    for s_row in sample_reader:
        ...
        print(sample_result)
        end_result.append((sample_result))
    print(end_result)

with open("/media/ssteindl/fairicube/uc3/uc3-drosophola-genetics/projects/WormPicker/output/layerdata.csv", "w", newline="") as csvfile:
